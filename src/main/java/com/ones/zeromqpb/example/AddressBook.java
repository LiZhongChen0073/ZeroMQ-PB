...
public final class AddressBook extends
        ...
        switch (tag) {
          ...
          case 10: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              this.people_ = new java.util.ArrayList<com.ones.zeromqpb.example.Person>();
              mutable_bitField0_ |= 0x00000001;
            }
            this.people_.add(
                input.readMessage(com.ones.zeromqpb.example.Person.parser(), extensionRegistry));
            break;
          }
          default: {
  ...
  getDescriptor() {
    return com.ones.zeromqpb.example.AddressBookProtos.internal_static_tutorial_AddressBook_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
  internalGetFieldAccessorTable() {
    return com.ones.zeromqpb.example.AddressBookProtos.internal_static_tutorial_AddressBook_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            AddressBook.class, AddressBook.Builder.class);
  }

  public static final int PEOPLE_FIELD_NUMBER = 1;
  private java.util.List<com.ones.zeromqpb.example.Person> people_;

  /**
   * <code>repeated .tutorial.Person people = 1;</code>
   */
  @java.lang.Override
  public java.util.List<com.ones.zeromqpb.example.Person> getPeopleList() {
    return this.people_;
  }
