...
public interface PersonOrBuilder extends
   ...
   */
  java.util.List<com.ones.zeromqpb.example.Person.PhoneNumber>
  getPhonesList();

  /**
   * <code>repeated .tutorial.Person.PhoneNumber phones = 4;</code>
   */
  com.ones.zeromqpb.example.Person.PhoneNumber getPhones(int index);
   ...
   * <code>repeated .tutorial.Person.PhoneNumber phones = 4;</code>
   */
  java.util.List<? extends com.ones.zeromqpb.example.Person.PhoneNumberOrBuilder>
  getPhonesOrBuilderList();

  /**
   * <code>repeated .tutorial.Person.PhoneNumber phones = 4;</code>
   */
  com.ones.zeromqpb.example.Person.PhoneNumberOrBuilder getPhonesOrBuilder(
      int index);
